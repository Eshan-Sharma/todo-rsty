# Using the RSTY Stack for Todo application
...
There are two empty spaces in the MIT license you need to fill out: ``and`eshan-sharma <43044334+Eshan-Sharma@users.noreply.github.com>`.
